...
public class Start {
	 ...
	 * @param Exponencial
	 * */
	private static void trataEventoUploadPublisher(Publisher publisher, double tempo, Exponencial uploadPublisher) {
	 ...
	 * @param Object
	 * */
	private static void trataEventoUploadPeer(double tempo, Exponencial uploadPeer, Peer peer, Publisher publisher, Object saidaPeer) {
